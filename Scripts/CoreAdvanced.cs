...
#nullable enable
    ...
    public void SmartEnhance(string? className, bool ForceEnh = false)
    {
        ...
        Core.Logger($"[SmartEnhance] {className}: type={(EnhancementType)type}, cape={cSpecial}, helm={hSpecial}, weapon={wSpecial}");
        new CoreEnhancements().EnhanceEquipped((EnhancementType)type, cSpecial, hSpecial, wSpecial);
