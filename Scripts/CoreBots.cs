...
public class CoreBots
{
    ...
    public void SetOptions(bool changeTo = true, bool disableClassSwap = false, bool disableCoreSkills = false)
    {
        ...
        if (changeTo)
        {
            ...
            string server = Bot.Options.ReloginServer ?? "Twig";
            int loginAttempt = 0;
...
#nullable enable
    ...
    */
    ...
    private const string PreferredReloginServerDefault = "Twig";
    ...
    public void Relogin(string reason = "")
    {
        ...
        try
        {
            ...
            string preferredServer = Bot.Options.ReloginServer ?? PreferredReloginServerDefault;
            ...
            while (!Bot.ShouldExit)
            {
                ...
                try
                {
                    relogSuccess = Bot.Servers.EnsureRelogin(preferredServer);
                }
                catch (Exception ex)
                {
                    Bot.Log($"⚠️ Relogin attempt threw: {ex.Message}");
                }
            ...
            Bot.Log("ℹ️ Relogin aborted because the script is stopping.");
        }
        finally
        {
...
public class CoreEnhancements
{
    ...
    public void Apply(string className)
    {
        ...
        switch (normalized)
        {
            ...
            case "great thief":
                EnhanceEquipped(
                    hSpecial: uVim() ? HelmSpecial.Vim : HelmSpecial.Forge,
                    type: EnhancementType.Lucky,
                    wSpecial: WeaponSpecial.Ravenous,
                    cSpecial: CapeSpecial.Lament
                );
            ...
            case "lightcaster":
                EnhanceEquipped(
                    ...
                    wSpecial: uDauntless() ? WeaponSpecial.Ravenous : WeaponSpecial.Praxis,
                    cSpecial: CapeSpecial.Vainglory
                );
                break;
            ...
            case "master ranger":
                EnhanceEquipped(
                    type: EnhancementType.Lucky,
                    hSpecial: HelmSpecial.Anima,
                    wSpecial: uDauntless() ? WeaponSpecial.Arcanas_Concerto : WeaponSpecial.Praxis,
                    cSpecial: CapeSpecial.Vainglory
                );
                break;
            ...
            default:
                C.Logger($"[CoreEnhancements] No enhancement preset available for: {className}");
                break;
        }
    }
